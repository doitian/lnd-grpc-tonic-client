    ...
    impl FailureCode {
        ...
        pub fn as_str_name(&self) -> &'static str {
            match self {
                ...
                FailureCode::RequiredNodeFeatureMissing => "REQUIRED_NODE_FEATURE_MISSING",
                FailureCode::RequiredChannelFeatureMissing => "REQUIRED_CHANNEL_FEATURE_MISSING",
                ...
                FailureCode::InvalidOnionBlinding => "INVALID_ONION_BLINDING",
        ...
        pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
            match value {
                ...
                "REQUIRED_CHANNEL_FEATURE_MISSING" => Some(Self::RequiredChannelFeatureMissing),
...
impl OutputScriptType {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            ...
            OutputScriptType::ScriptTypeWitnessV0PubkeyHash => "SCRIPT_TYPE_WITNESS_V0_PUBKEY_HASH",
            OutputScriptType::ScriptTypeWitnessV0ScriptHash => "SCRIPT_TYPE_WITNESS_V0_SCRIPT_HASH",
            ...
            OutputScriptType::ScriptTypeWitnessV1Taproot => "SCRIPT_TYPE_WITNESS_V1_TAPROOT",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
        match value {
            ...
            "SCRIPT_TYPE_WITNESS_V0_PUBKEY_HASH" => Some(Self::ScriptTypeWitnessV0PubkeyHash),
            "SCRIPT_TYPE_WITNESS_V0_SCRIPT_HASH" => Some(Self::ScriptTypeWitnessV0ScriptHash),
...
impl PaymentFailureReason {
    ...
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
        match value {
            ...
            "FAILURE_REASON_INSUFFICIENT_BALANCE" => Some(Self::FailureReasonInsufficientBalance),
            _ => None,
        }
    }
}
...
pub mod lightning_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        ) -> std::result::Result<tonic::Response<super::ChannelBalanceResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
        ...
        ) -> std::result::Result<tonic::Response<super::TransactionDetails>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
        ...
        pub async fn send_coins(
        ...
        ) -> std::result::Result<tonic::Response<super::SendCoinsResponse>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("lnrpc.Lightning", "SendCoins"));
            self.inner.unary(req, path, codec).await
        }
        /// lncli: `listunspent`
        ...
        ) -> std::result::Result<tonic::Response<super::ListUnspentResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
        ...
        pub async fn send_many(
        ...
        ) -> std::result::Result<tonic::Response<super::SendManyResponse>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("lnrpc.Lightning", "SendMany"));
            self.inner.unary(req, path, codec).await
        }
        /// lncli: `newaddress`
        ...
        ) -> std::result::Result<tonic::Response<super::VerifyMessageResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
        ...
        pub async fn list_peers(
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("lnrpc.Lightning", "ListPeers"));
            self.inner.unary(req, path, codec).await
        }
        ///
        ...
        pub async fn get_info(
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("lnrpc.Lightning", "GetInfo"));
            self.inner.unary(req, path, codec).await
        }
        /// lncli: 'getdebuginfo'
        ...
        ) -> std::result::Result<tonic::Response<super::GetDebugInfoResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static("/lnrpc.Lightning/GetDebugInfo");
            let mut req = request.into_request();
            req.extensions_mut()
        ...
        ) -> std::result::Result<tonic::Response<super::GetRecoveryInfoResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
        ...
        ) -> std::result::Result<tonic::Response<super::PendingChannelsResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
        ...
        ) -> std::result::Result<tonic::Response<super::ClosedChannelsResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
        ...
        ) -> std::result::Result<tonic::Response<super::BatchOpenChannelResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
        ...
        ) -> std::result::Result<tonic::Response<super::FundingStateStepResp>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
        ...
        ) -> std::result::Result<tonic::Response<super::AbandonChannelResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
        ...
        ) -> std::result::Result<tonic::Response<super::ListInvoiceResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
        ...
        ) -> std::result::Result<tonic::Response<super::DeletePaymentResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
        ...
        ) -> std::result::Result<tonic::Response<super::DeleteAllPaymentsResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
        ...
        ) -> std::result::Result<tonic::Response<super::NodeMetricsResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
        ...
        ) -> std::result::Result<tonic::Response<super::QueryRoutesResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
        ...
        ) -> std::result::Result<tonic::Response<super::DebugLevelResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
        ...
        pub async fn fee_report(
        ...
        ) -> std::result::Result<tonic::Response<super::FeeReportResponse>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("lnrpc.Lightning", "FeeReport"));
            self.inner.unary(req, path, codec).await
        }
        ...
        ) -> std::result::Result<tonic::Response<super::PolicyUpdateResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
        ...
        ) -> std::result::Result<tonic::Response<super::ForwardingHistoryResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
        ...
        ) -> std::result::Result<tonic::Response<super::ChanBackupSnapshot>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
        ...
        ) -> std::result::Result<tonic::Response<super::VerifyChanBackupResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
        ...
        ) -> std::result::Result<tonic::Response<super::RestoreBackupResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
        ...
        ) -> std::result::Result<tonic::Response<super::BakeMacaroonResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
        ...
        ) -> std::result::Result<tonic::Response<super::ListMacaroonIDsResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
        ...
        ) -> std::result::Result<tonic::Response<super::DeleteMacaroonIdResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
        ...
        ) -> std::result::Result<tonic::Response<super::CheckMacPermResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
        ...
        ) -> std::result::Result<tonic::Response<super::SendCustomMessageResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
        ...
        ) -> std::result::Result<tonic::Response<super::ListAliasesResponse>, tonic::Status>
        {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static("/lnrpc.Lightning/ListAliases");
            let mut req = request.into_request();
            req.extensions_mut()
        ...
        ) -> std::result::Result<tonic::Response<super::LookupHtlcResolutionResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path =
                http::uri::PathAndQuery::from_static("/lnrpc.Lightning/LookupHtlcResolution");
            let mut req = request.into_request();
            req.extensions_mut()
